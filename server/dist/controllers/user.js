...
const setDeletImage = async (req, res) => {
...
const setUserImage = async (req, res) => {
    try {
        const userId = req.userId;
        const response = await prisma.userSchema.findUnique({
            where: {
...
const userTersting = async (req, res) => {
    const userId = req.userId;
...
export { checkUser, setUserInfo, setUserImage, getUserInfo, setDeletImage, deleteSession, userTersting };
